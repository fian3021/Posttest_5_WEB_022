<?php
    ...
    if(isset($_POST['kirim'])){
        ...
        // mysqli_query($db, "INSERT INTO member_istorii (Genre_Favorit) VALUES('".$fav."')");
        
        $result = mysqli_query($db, 
        "INSERT INTO member_istorii (Email, Nama, Usia, Gender, Genre_Favorit) 
        VALUES ('$email', '$nama','$usia','$gender', '".$fav."')");
            ...
            <ul class="join">
                ...
                <form action="" method="post">
                    ...
                    <table>
                         ...
                         <div class="form">
                            <input type="submit" name="kirim" class="submit" value="join" />
                         </div>
                    </table>
                </form>
            </ul>
